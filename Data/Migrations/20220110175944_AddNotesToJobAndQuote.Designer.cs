...
namespace NestLinkV2.Data.Migrations
{
    ...
    [Migration("20220110175944_AddNotesToJobAndQuote")]
    partial class AddNotesToJobAndQuote
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NestLinkV2.Models.ClientUser", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NestLinkV2.Models.JobNote", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NestLinkV2.Models.JobProduct", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NestLinkV2.Models.ProductType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NestLinkV2.Models.QuoteAppointment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NestLinkV2.Models.QuoteNote", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("QuoteNotes");
                });

            modelBuilder.Entity("NestLinkV2.Models.QuoteProduct", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NestLinkV2.Models.Technician", b =>
                {
                    ...
                    b.HasIndex("CurrentJobId")
                        .IsUnique()
                        .HasFilter("[CurrentJobId] IS NOT NULL");
            ...
            modelBuilder.Entity("NestLinkV2.Models.ClientUser", b =>
                {
                    b.HasOne("NestLinkV2.Models.ApplicationUser", "User")
                        .WithOne("ClientUser")
                        .HasForeignKey("NestLinkV2.Models.ClientUser", "AspNetUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NestLinkV2.Models.Product", b =>
                {
                    b.HasOne("NestLinkV2.Models.ProductType", "ProductType")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("NestLinkV2.Models.QuoteAppointment", b =>
                {
                    b.HasOne("NestLinkV2.Models.Quote", "Quote")
                        .WithOne("QuoteAppointment")
                        .HasForeignKey("NestLinkV2.Models.QuoteAppointment", "QuoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NestLinkV2.Models.Technician", "Technician")
                        .WithMany("QuoteAppointments")
            ...
            modelBuilder.Entity("NestLinkV2.Models.Technician", b =>
                {
                    ...
                    b.HasOne("NestLinkV2.Models.Job", "CurrentJob")
                        .WithOne("CurrentTechnician")
                        .HasForeignKey("NestLinkV2.Models.Technician", "CurrentJobId");
                });
